...
Bitte installieren Sie hierfür die aktuelle Version von R unter: https://stat.ethz.ch/CRAN/ 

Darüber hinaus werden wir mit der *integrierten Entwicklungsumgebung* (IDE) RStudio arbeiten. Die aktuelle Version findet sich unter: https://www.rstudio.com/products/rstudio/download/ 
...
## 0.4 Aller Einstieg ist schwer, aber unser so leicht wie möglich?!
...
Um diesem Anspruch gerecht werden zu können, werden wir uns vornehmlich in relativ "abgeschlossenen" Ökosystemen (Ecosystems) bewegen, also Sammlungen von Packages, die aufeinander abgestimmt wurden. Das bekannteste Beispiel ist hierfür sicherlich das *tidyverse*, welches maßgebend von einem der großen R-Pioniere und RStudio-Direktor Hadley Wickham entwickelt wurde. Auf Grundlage des selbigen werden wir noch die Packages von Daniel Lüdecke *strengejacke* und die beeindruckenden Modellierungsvereinfachungen in *easystats* kennen lernen. So repräsentieren diese Packages in vollem Umfang den "state-of-the-art" sozialwissenschaftlicher Datenanalysetechniken, obgleich der Lernprozess damit deutlich vereinfacht ist. Zudem werden alle genannten Packages, vor allem das tidyverse, auch in nicht-universitären Kontexten grundlegend genutzt.
