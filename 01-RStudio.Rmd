...
Zur Erstellung eines RScript öffnen wir über das Symbol mit dem weißen Blatt und grünem Kreuz ein neues RScript (Shortcut: `cmd bzw. strg` + `up` + `N`). Vorteile sind hier, wie auch in SPSS, die Möglichkeit zur übersichtlichen und nachvollziehbaren Arbeitsweise und das Speichern von Auswertungen.
...
y enthält nun sieben Zahlen - 7L. Der Befehl `c()` wird immer bei einer Aufreihung von Werten genutzt.  
