...
|---|---|---|
| **Werkzeug** | 1–3 | RStudio einrichten, Quarto-Berichte verstehen, R-Grundlagen |
| **Daten** | 4–5 | SPSS-Datensatz einlesen, Variablen finden, Skalen bilden |
| **Visualisierung** | 6 | ggplot2-Grammatik, Geoms, Facets, Themes |
| **Analyse** | 7 | uni- und bivariate Statistik (Häufigkeiten, Tests, Korrelationen) |
| **Modelle** | 8–9 | Latente Strukturen (EFA, Reliabilität, CFA) und Erklärungsmodelle (ANOVA, Regression) |
