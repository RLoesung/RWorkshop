...
| :------------- | :------------------ | :------------------------ |
| Daten konvertieren:                                                     |
| sjlabelled     | to_factor()         | Konvertiert Variable in Faktor |
| sjlabelled     | to_numeric()        | Konvertiert Variable in numerischen Vektor |
| sjlabelled     | to_label()          | Ersetzt Levels mit Ausprägungsmerkmalen als Faktor* |
| sjlabelled     | to_character()      | Bildet Faktor mit `character` Vektor |
...
| sjmisc         | replace_na()        | Transformiert `NA` zu gültigem Ausprägungsmerkmal |
| sjlabelled     | unlabel()           | Konvertiert `labelled class` in `atomare Struktur` |
| Datenbeschriftung:                                                   |
| sjlabelled     | get_label()         | Ruft Variablenbeschriftung ab |
| sjlabelled     | get_labels()        | Ruft Wertbeschriftung von Ausprägungsmerkmalen ab |
| sjlabelled     | remove_all_labels() | Entfernt alle Beschriftungen |
| sjlabelled     | set_label()         | Variable neubeschriften |
| sjlabelled     | set_labels()        | Ausprägungsmerkmale neubeschriften |
| sjlabelled     | drop_labels()       | Alle "unbesetzten" Ausprägungsmerkmale löschen |

*Entspricht dem Ergebnis der Funktion `factor()`, sofern nicht über `read_spss` Daten importiert wurden.
