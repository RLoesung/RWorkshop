...
R verspricht eine enorme Flexibilität im Umgang mit Daten. Unmittelbar spürbar wird dieser Umstand in der Reorganisation von Datensätzen in neuen Objekten. So wollen wir im ersten Schritt lernen, wie wir die restrukturierten Daten in einem neuen Datensatz speichern können. Hierfür benötigen wir die folgenden Funktionen:
