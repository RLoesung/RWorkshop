...
Im Default wird dabei eine neue Variable mit dem Suffix "_z" erstellt. Im Beispiel aus der Syntax würde im Datensatz eine neue Variable mit dem Namen `variable1_z` gebildet werden.
